...
theorem John_neither_wedding_attended_nor_Paris : ¬ Well_attended Johns_wedding ∧ ¬ Honeymoon_Paris John :=
begin
  sorry
end


theorem not_John_neither_wedding_attended_nor_Paris : Well_attended Johns_wedding ∨ Honeymoon_Paris John :=
begin
  sorry
end
