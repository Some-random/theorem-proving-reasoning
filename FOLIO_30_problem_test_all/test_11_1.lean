...
theorem some_orchestras_premiered_music_pieces : ∃ (o : Orchestra) (m : MusicPiece), premieres o m :=
begin
  sorry
end


theorem not_some_orchestras_premiered_music_pieces : ¬ ∃ (o : Orchestra) (m : MusicPiece), premieres o m :=
begin
  sorry
end
