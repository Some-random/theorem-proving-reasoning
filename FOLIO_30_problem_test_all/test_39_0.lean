...
theorem onate_visited_new_mexico : ∃ (m : MountainRange), visited JuanDeOnate m ∧ is_in_NewMexico m :=
begin
  sorry
end


theorem not_onate_visited_new_mexico : ¬ ∃ (m : MountainRange), visited JuanDeOnate m ∧ is_in_NewMexico m :=
begin
  sorry
end
