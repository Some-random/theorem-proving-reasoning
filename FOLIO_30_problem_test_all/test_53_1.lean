...
theorem Remy_has_impressive_office_and_visits_store : Has_impressive_home_office Remy ∧ Visits_office_supply_store Remy :=
begin
  sorry
end


theorem not_Remy_has_impressive_office_and_visits_store : ¬ (Has_impressive_home_office Remy ∧ Visits_office_supply_store Remy) :=
begin
  sorry
end
