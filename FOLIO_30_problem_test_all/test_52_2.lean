...
theorem palace_of_flies_translated_from_italian : is_translated_from_Italian PalaceOfFlies :=
begin
  sorry
end


theorem not_palace_of_flies_translated_from_italian : ¬ is_translated_from_Italian PalaceOfFlies :=
begin
  sorry
end
