...
theorem no_pappys_starred : ¬ ∃ (s : Series) (c : Channel), stars_in Pappys s ∧ piloted_in s c :=
begin
  sorry
end


theorem not_no_pappys_starred : ∃ (s : Series) (c : Channel), stars_in Pappys s ∧ piloted_in s c :=
begin
  sorry
end
