...
theorem koala_quokka_sleep_fluffy : Koala = Quokka → loves_to_sleep Koala ∨ is_very_fluffy Koala :=
begin
  sorry
end


theorem not_koala_quokka_sleep_fluffy : ¬ (Koala = Quokka → loves_to_sleep Koala ∨ is_very_fluffy Koala) :=
begin
  sorry
end
