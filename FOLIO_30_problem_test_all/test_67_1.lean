...
theorem Yuri_not_American_basketball_player : ¬ (American Yuri ∧ Basketball_player Yuri) :=
begin
  sorry
end


theorem not_Yuri_not_American_basketball_player : ¬ ¬ (American Yuri ∧ Basketball_player Yuri) :=
begin
  sorry
end
