...
theorem tom_can_apply_for_financial_aid : can_apply_for_financial_aid Tom GRE :=
begin
  sorry
end


theorem not_tom_can_apply_for_financial_aid : ¬ can_apply_for_financial_aid Tom GRE :=
begin
  sorry
end
