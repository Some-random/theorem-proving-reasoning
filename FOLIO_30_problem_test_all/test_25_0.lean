...
theorem joes_plate_begins_with_34 : ∃ (p : Plate), has_plate Joe p ∧ begins_with_34 p :=
begin
  sorry
end


theorem not_joes_plate_begins_with_34 : ¬ ∃ (p : Plate), has_plate Joe p ∧ begins_with_34 p :=
begin
  sorry
end
