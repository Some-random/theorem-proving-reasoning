...
theorem Taylor_neither_grew_up_health_conscious_nor_visits_gym : ¬ Grew_up_health_conscious Taylor ∧ ¬ Visits_gym_daily Taylor :=
begin
  sorry
end


theorem not_Taylor_neither_grew_up_health_conscious_nor_visits_gym : ¬ (¬ Grew_up_health_conscious Taylor ∧ ¬ Visits_gym_daily Taylor) :=
begin
  sorry
end
