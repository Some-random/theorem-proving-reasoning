...
theorem subway_take_out_positive_reviews : ¬ does_not_provide_take_out_service Subway ∧ ¬ receives_many_negative_reviews Subway :=
begin
  sorry
end


theorem not_subway_take_out_positive_reviews : ¬ (¬ does_not_provide_take_out_service Subway ∧ ¬ receives_many_negative_reviews Subway) :=
begin
  sorry
end
