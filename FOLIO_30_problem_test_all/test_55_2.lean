...
theorem james_takes_database_course_or_has_part_time_job : Takes_database_course James ∨ Has_part_time_job James :=
begin
  sorry
end


theorem not_james_takes_database_course_or_has_part_time_job : ¬ (Takes_database_course James ∨ Has_part_time_job James) :=
begin
  sorry
end
