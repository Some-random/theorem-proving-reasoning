...
theorem smarter_person_gained_knowledge : ∀ (p : Person), is_smarter p → gains_knowledge p :=
begin
  sorry
end


theorem not_smarter_person_gained_knowledge : ¬ (∀ (p : Person), is_smarter p → gains_knowledge p) :=
begin
  sorry
end
