...
theorem Yale_has_largest_endowment : ∀ (u : University) (n : ℕ), has_endowment u n → n ≤ 42300000000 :=
begin
  sorry
end


theorem not_Yale_has_largest_endowment : ¬ ∀ (u : University) (n : ℕ), has_endowment u n → n ≤ 42300000000 :=
begin
  sorry
end
