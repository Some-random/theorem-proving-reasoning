...
theorem subway_take_out_negative_reviews : ¬ does_not_provide_take_out_service Subway ∧ receives_many_negative_reviews Subway → has_rating_greater_than_9 Subway ∧ does_not_provide_take_out_service Subway :=
begin
  sorry
end


theorem not_subway_take_out_negative_reviews : ¬ (¬ does_not_provide_take_out_service Subway ∧ receives_many_negative_reviews Subway → has_rating_greater_than_9 Subway ∧ does_not_provide_take_out_service Subway) :=
begin
  sorry
end
