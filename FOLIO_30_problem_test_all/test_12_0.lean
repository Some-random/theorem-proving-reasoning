...
theorem max_design_is_mass_product : ∀ (d : Design), design_style Max d → mass_product_design d :=
begin
  sorry
end


theorem not_max_design_is_mass_product : ∀ (d : Design), design_style Max d → ¬ mass_product_design d :=
begin
  sorry
end
