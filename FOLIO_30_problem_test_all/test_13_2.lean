...
theorem coco_gauff_not_lost_to_swiatek_or_most_active : ¬ (lost_to CocoGauff IgaSwiatek ∨ is_most_active_major_tennis CocoGauff) :=
begin
  sorry
end


theorem not_coco_gauff_not_lost_to_swiatek_or_most_active : lost_to CocoGauff IgaSwiatek ∨ is_most_active_major_tennis CocoGauff :=
begin
  sorry
end
