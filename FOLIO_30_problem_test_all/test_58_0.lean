...
theorem breaking_bad_on_monday : ∃ (t : Time), t = Monday_8_pm ∧ roses_given_out BreakingBad t :=
begin
  sorry
end


theorem not_breaking_bad_on_monday : ¬ ∃ (t : Time), t = Monday_8_pm ∧ roses_given_out BreakingBad t :=
begin
  sorry
end
