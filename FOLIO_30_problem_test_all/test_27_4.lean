...
theorem dried_thai_chilies_cupcake_product : is_cupcake DriedThaiChilies ∧ is_product_of DriedThaiChilies BakedByMelissa :=
begin
  sorry
end


theorem not_dried_thai_chilies_cupcake_product : ¬ is_cupcake DriedThaiChilies ∨ ¬ is_product_of DriedThaiChilies BakedByMelissa :=
begin
  sorry
end
