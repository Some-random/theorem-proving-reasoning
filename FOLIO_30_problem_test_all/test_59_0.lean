...
theorem heinrich_is_german_or_russian : is_German Heinrich_Schmidt ∨ is_Russian Heinrich_Schmidt :=
begin
  sorry
end


theorem not_heinrich_is_german_or_russian : ¬ (is_German Heinrich_Schmidt ∨ is_Russian Heinrich_Schmidt) :=
begin
  sorry
end
