...
theorem roderick_leads_creed : ∃ (s : WrestlingStable), leads RoderickStrong s ∧ includes s CreedBrothers :=
begin
  sorry
end


theorem not_roderick_leads_creed : ¬ ∃ (s : WrestlingStable), leads RoderickStrong s ∧ includes s CreedBrothers :=
begin
  sorry
end
