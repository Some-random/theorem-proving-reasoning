...
theorem lewandowski_plays_for_bayern : plays_for RobertLewandowski BayernMunchen :=
begin
  sorry
end


theorem not_lewandowski_plays_for_bayern : ¬ plays_for RobertLewandowski BayernMunchen :=
begin
  sorry
end
