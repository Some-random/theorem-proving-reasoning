...
theorem mine_not_in_new_mexico : ¬ ∃ (m : MountainRange), is_located_in HardingPegmatiteMine m ∧ is_in_NewMexico m :=
begin
  sorry
end


theorem not_mine_not_in_new_mexico : ∃ (m : MountainRange), is_located_in HardingPegmatiteMine m ∧ is_in_NewMexico m :=
begin
  sorry
end
