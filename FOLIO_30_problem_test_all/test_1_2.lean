...
theorem not_james_condition : ¬ ((is_manager James ∨ is_in_other_countries James) → (has_lunch_at_home James ∧ works_remotely James) ∨ (¬ has_lunch_at_home James ∧ ¬ works_remotely James)) :=
begin
  sorry
end
