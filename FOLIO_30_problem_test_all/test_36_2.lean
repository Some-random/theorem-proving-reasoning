...
theorem no_financial_aid_for_gre : ¬ ∃ (p : Person), can_apply_for_financial_aid p GRE :=
begin
  sorry
end


theorem not_no_financial_aid_for_gre : ∃ (p : Person), can_apply_for_financial_aid p GRE :=
begin
  sorry
end
