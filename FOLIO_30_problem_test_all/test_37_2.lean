...
theorem Peter_foodie_and_high_income_or_not : (Foodie Peter ∧ (∃ h : Household, Belongs_to Peter h ∧ High_income h)) ∨ (¬ Foodie Peter ∧ ¬ (∃ h : Household, Belongs_to Peter h ∧ High_income h)) :=
begin
  sorry
end


theorem not_Peter_foodie_and_high_income_or_not : ¬ ((Foodie Peter ∧ (∃ h : Household, Belongs_to Peter h ∧ High_income h)) ∨ (¬ Foodie Peter ∧ ¬ (∃ h : Household, Belongs_to Peter h ∧ High_income h))) :=
begin
  sorry
end
