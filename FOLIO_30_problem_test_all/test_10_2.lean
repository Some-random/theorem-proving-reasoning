...
theorem imperium_no_feud : ¬ ∃ (s : WrestlingStable), has_feud_with Imperium s ∧ includes s IvyNile :=
begin
  sorry
end


theorem not_imperium_no_feud : ∃ (s : WrestlingStable), has_feud_with Imperium s ∧ includes s IvyNile :=
begin
  sorry
end
