...
theorem steinhauer_not_winner : ¬ is_winner_of Steinhauer du_Maurier_Classic_1992 :=
begin
  sorry
end


theorem not_steinhauer_not_winner : is_winner_of Steinhauer du_Maurier_Classic_1992 :=
begin
  sorry
end
