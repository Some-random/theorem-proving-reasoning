...
theorem Yuri_American_basketball_player : American Yuri ∧ Basketball_player Yuri :=
begin
  sorry
end


theorem not_Yuri_American_basketball_player : ¬ (American Yuri ∧ Basketball_player Yuri) :=
begin
  sorry
end
