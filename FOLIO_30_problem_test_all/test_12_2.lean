...
theorem max_design_is_evocative_or_dreamy : ∀ (d : Design), design_style Max d → evocative d ∨ dreamy d :=
begin
  sorry
end


theorem not_max_design_is_evocative_or_dreamy : ∀ (d : Design), design_style Max d → ¬ (evocative d ∨ dreamy d) :=
begin
  sorry
end
