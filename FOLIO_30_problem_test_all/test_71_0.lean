...
theorem no_one_at_nautico_is_brazilian : ∀ (p : Person), plays_for p Nautico → ¬ is_Brazilian p :=
begin
  sorry
end


theorem not_no_one_at_nautico_is_brazilian : ¬ (∀ (p : Person), plays_for p Nautico → ¬ is_Brazilian p) :=
begin
  sorry
end
