...
theorem unsupervised_learning_used : is_used_to_train UnsupervisedLearning TextSummarizationModel :=
begin
  sorry
end


theorem not_unsupervised_learning_used : ¬ is_used_to_train UnsupervisedLearning TextSummarizationModel :=
begin
  sorry
end
