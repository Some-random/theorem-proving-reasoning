...
theorem onenineeightfour_is_printed_text : is_printed_text onenineeightfour :=
begin
  sorry
end


theorem not_onenineeightfour_is_printed_text : ¬ is_printed_text onenineeightfour :=
begin
  sorry
end
