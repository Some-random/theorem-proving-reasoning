...
theorem world_championships_is_sporting_event : is_sporting_event WorldChampionships :=
begin
  sorry
end


theorem not_world_championships_is_sporting_event : ¬ is_sporting_event WorldChampionships :=
begin
  sorry
end
