...
theorem Mary_not_picky_and_spends_time_eating : Not_picky_eater Mary ∧ Spends_time_eating_with_friends Mary :=
begin
  sorry
end


theorem not_Mary_not_picky_and_spends_time_eating : ¬ (Not_picky_eater Mary ∧ Spends_time_eating_with_friends Mary) :=
begin
  sorry
end
