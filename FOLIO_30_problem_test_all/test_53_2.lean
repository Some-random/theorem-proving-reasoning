...
theorem Remy_condition : (Late_bedtime Remy ∨ Visits_office_supply_store Remy) → ¬ Organizes_home Remy ∧ ¬ Has_impressive_home_office Remy :=
begin
  sorry
end


theorem not_Remy_condition : ¬ ((Late_bedtime Remy ∨ Visits_office_supply_store Remy) → ¬ Organizes_home Remy ∧ ¬ Has_impressive_home_office Remy) :=
begin
  sorry
end
