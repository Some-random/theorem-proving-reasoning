...
theorem Pierson_is_residential_college_at_Yale : is_residential_college_at_Yale Pierson :=
begin
  sorry
end


theorem not_Pierson_is_residential_college_at_Yale : ¬ is_residential_college_at_Yale Pierson :=
begin
  sorry
end
