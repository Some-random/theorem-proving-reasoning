...
theorem harry_potter_published_by_new_vessel_press : is_published_by_NewVesselPress HarryPotter :=
begin
  sorry
end


theorem not_harry_potter_published_by_new_vessel_press : ¬ is_published_by_NewVesselPress HarryPotter :=
begin
  sorry
end
