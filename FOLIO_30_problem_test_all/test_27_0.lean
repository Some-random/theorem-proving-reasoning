...
theorem dried_thai_chilies_product : is_product_of DriedThaiChilies BakedByMelissa :=
begin
  sorry
end


theorem not_dried_thai_chilies_product : ¬ is_product_of DriedThaiChilies BakedByMelissa :=
begin
  sorry
end
