...
theorem machine_translation_is_generation : is_language_generation_task MachineTranslation :=
begin
  sorry
end


theorem not_machine_translation_is_generation : ¬ is_language_generation_task MachineTranslation :=
begin
  sorry
end
