...
theorem Yuri_condition_2 : ¬ (American Yuri ∧ Basketball_player Yuri) → Basketball_player Yuri :=
begin
  sorry
end


theorem not_Yuri_condition_2 : ¬ (¬ (American Yuri ∧ Basketball_player Yuri) → Basketball_player Yuri) :=
begin
  sorry
end
