...
-- Rule R2: Rough and young people are nice
axiom R2 : ∀ x : obj, Rough x ∧ Young x → Nice x

-- Rule R3: Cold and red people are smart
...
-- Rule R6: All rough and nice people are red
axiom R6 : ∀ x : obj, Rough x ∧ Nice x → Red x

-- Rule R7: All red and quiet people are cold
