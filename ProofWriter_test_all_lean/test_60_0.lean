...
-- Rule R1: If Dave is kind and white then Dave is blue
...
-- Rule R7: If Anne is nice and not white then Anne is green
axiom R7 : Nice Anne ∧ ¬ White Anne → Green Anne

-- Rule R8: If Dave is white and blue then Dave is green
