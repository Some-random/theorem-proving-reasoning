...
-- Rule R2: If Bob is young and cold then Bob is furry
axiom R2 : Young Bob ∧ Cold Bob → Furry Bob

-- Rule R3: Young things are cold
axiom R3 : ∀ x : obj, Young x → Cold x

-- Rule R4: If Fiona is rough and cold then Fiona is smart
axiom R4 : Rough Fiona ∧ Cold Fiona → Smart Fiona

-- Rule R5: Cold and furry things are white
axiom R5 : ∀ x : obj, Cold x ∧ Furry x → White x

-- Rule R6: All rough and nice things are young
