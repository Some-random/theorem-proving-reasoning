...
axiom R1 : Sees BaldEagle Rabbit → Big Rabbit
...
theorem bald_eagle_likes_rabbit : Likes BaldEagle Rabbit :=
begin
  sorry
end


theorem not_bald_eagle_likes_rabbit : ¬ Likes BaldEagle Rabbit :=
begin
  sorry
end
