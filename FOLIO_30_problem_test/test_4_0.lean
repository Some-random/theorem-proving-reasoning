...
theorem real_madrid_ranks_higher : ranks_higher_than RealMadrid Barcelona Y2021_2022 :=
begin
  sorry
end


theorem not_real_madrid_ranks_higher : ¬ ranks_higher_than RealMadrid Barcelona Y2021_2022 :=
begin
  sorry
end
