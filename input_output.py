...
example_outputs1 = "".join(open("output1.lean").readlines())
...
example_outputs2 = "".join(open("output2.lean").readlines())
...
example_outputs3 = "".join(open("output3.lean").readlines())
...
example_outputs4 = "".join(open("output4.lean").readlines())
...
example_outputs5 = "".join(open("output5.lean").readlines())
...
example_outputs1_text = "".join(open("output1_text.txt").readlines())

example_outputs2_text = "".join(open("output2_text.txt").readlines())

example_outputs3_text = "".join(open("output3_text.txt").readlines())

example_outputs4_text = "".join(open("output4_text.txt").readlines())

example_outputs5_text = "".join(open("output5_text.txt").readlines())
