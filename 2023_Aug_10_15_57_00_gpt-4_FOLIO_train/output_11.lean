...
theorem not_sam_project_in_Cpp : ¬ written_in_Cpp Sam_Project :=
begin
    sorry,
end
...
-- Let's first prove the positive case.
theorem sam_plays_Perfect : plays_song Sam Perfect :=
begin
    apply A5 Perfect A4,
end
...
theorem not_sam_plays_Perfect : ¬ plays_song Sam Perfect :=
begin
...
-- Let's first prove the positive case.
theorem sam_plays_if_Perfect : Perfect = Perfect → plays_song Sam Perfect :=
begin
    sorry, -- Placeholder for proof
end
...
theorem not_sam_plays_if_Perfect : ¬ (Perfect = Perfect → plays_song Sam Perfect) :=
begin
    sorry, -- Placeholder for proof
end
